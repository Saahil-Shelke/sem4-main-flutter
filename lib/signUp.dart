...
class _SignUpState extends State<SignUp> {
  ...
  Widget build(BuildContext context) {
    ...
    GestureDetector(
      onTap : () {
        FirebaseAuth.instance.createUserWithEmailAndPassword(email: emailCon.text.trim(), password: passCon.text.trim()).then((value) {
      ...
      child: Row(
        children: [
          Container( //Icon1
            width: screenWidth / 6,
            child: Icon (
              pic == "email"? Icons.email : pic =="person"? Icons.person : Icons.lock,
              color: primary,
              size: screenWidth / 15,
            ),
          ),
